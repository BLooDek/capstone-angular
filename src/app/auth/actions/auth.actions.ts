...
import {ILoginPayload, IRegisterPayload, IUserData, IUserToken} from "../models/auth.models";
...
export const GetUserDataActionSuccess = createAction('[Auth] Get User Data Success', props<IUserData>());
export const GetUserDataActionError = createAction('[Auth] Get User Data Error', props<{ error: any }>());
